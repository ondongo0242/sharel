...
function getDeploymentUrl() {
  ...
  if (process.env.REPLIT_DEV_DOMAIN) {
    const worfDomain = process.env.REPLIT_DEV_DOMAIN.replace('janeway', 'worf');
    const url = `https://${worfDomain}`;
    console.log("Using WORF domain (transformed from REPLIT_DEV_DOMAIN):", url);
    return url;
  }
